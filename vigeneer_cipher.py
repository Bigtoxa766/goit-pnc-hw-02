...
'''Найбільш поширені відстані 60 та 84, що кратне 24, 12, 6 та 3.
Для визначення довжини ключа використовуємо саме ці значення по черзі,
поки не буде знайдено ключ'''
possible_lengths = 12
